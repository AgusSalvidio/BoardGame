# How to load BoardGame in a Pharo image
...
4. Evaluate:
    ...
    Metacello new
      baseline: 'BoardGame';
      repository: 'github://AgusSalvidio/BoardGame:release-candidate';
      load: 'Development'.
    ```
...
5. Select *Clone from github.com* and enter `AgusSalvidio` as owner name and `BoardGame`
   as project name
6. Click *Ok*
7. Select the repository in the main Iceberg window
8. Open the contextual menu and select
  *Metacello -> Install baseline of BoardGame ...*
